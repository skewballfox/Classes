...
public class Polyterm implements Comparable<Polyterm>{
    ...
    Polyterm(String input)
    {
        ...
        {
          coefficient = ScalarFactory.newScalar(1);
    ...
    public boolean equals(Object comparator)
    {
        if (this == comparator)
            ...
            if (this.coefficient.equals(other.getCoefficient()) && this.exponent==other.getExponent()){
                return true;
            } else {
                return false;
            }
    ...
    public Polyterm derive()
    {
        if (this.exponent!=0){
            ...
            return new Polyterm((SF.newScalar(0)),0);
        }
    }
